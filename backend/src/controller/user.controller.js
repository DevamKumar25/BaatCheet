...
// export async function getRecommendeUsers(req,res){
//     try {
...
export async function getRecommendeUsers(req, res) {
  ...
  res.status(200).json({ recommendedUsers: recommendedUser });
...
export async function sendFriendRequest(req,res) {
    try {
      ...
      //prevent sending request req to yourself
...
export async function getOutgoingFriendReqs(req,res) {
    try {
        ...
        console.log("Error in getOutgoingReq constroller",error.message);
        res.status(500).json({message:"Internal server error"});
    }
}